...
## Example 4:Calculate income elasticities
```r
...
## Example 5:Calculate price elasticities
```r
...
## Example 6: Get a dataset for parameter fitting from a sample training dataset
...
## Example 7: Analyze distribution of observational error for non-staples
```r
g<-ggplot()+
...
## Example 8:Analyze distribution of observational error for staples
```r
g<-ggplot()+
...
## Example 9:Calculate actual parameters
...
## Example 10: Run the interactive version of the model
