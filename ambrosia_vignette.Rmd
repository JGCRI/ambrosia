...
Sample_Data <- read.csv("paper1/sample_training_data/Training_Data.csv") 
...
```
```{r}
new_parameters <- calculate_ambrosia_params(datadir = "outputs/Processed_Data_for_MC.csv",trace_results = 1
                                            )
